package com.example.restTemplate.resttemplate.configuration;
...
import com.example.restTemplate.resttemplate.web.dto.Foo;
...
public class FooController {
    ...
    @ResponseBody
    public Foo headFoo() {
        return new Foo(1L, randomAlphabetic(4));
    }
