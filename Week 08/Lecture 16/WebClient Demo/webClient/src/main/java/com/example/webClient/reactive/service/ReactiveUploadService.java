package com.example.webClient.reactive.service;

import com.example.webClient.reactive.exception.ServiceException;
...
public class ReactiveUploadService {
    ...
    private static final String EXTERNAL_UPLOAD_URL = "ttp://localhost:8080/external/upload";
