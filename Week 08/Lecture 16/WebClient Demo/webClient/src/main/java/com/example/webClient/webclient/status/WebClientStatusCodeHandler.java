package com.example.webClient.webclient.status;

import com.example.webClient.webclient.status.exception.CustomBadRequestException;
import com.example.webClient.webclient.status.exception.CustomServerErrorException;
